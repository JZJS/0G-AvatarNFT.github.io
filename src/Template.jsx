...
const accData = [
  {
    title: "What makes '0G-AvatarNFT' unique compared to other platforms ?",
    content:
      "Unlike traditional NFT platforms, 0G-AvatarNFT leverages the power of Web3 technology to provide a decentralized and boundless experience. The platform also offers an immersive metaverse environment, where users can engage with NFTs in a dynamic and interactive way.",
  },
  {
    title: "How can I participate as an artist in 0G-AvatarNFT ?",
    content:
      "Unlike traditional NFT platforms, 0G-AvatarNFT leverages the power of Web3 technology to provide a decentralized and boundless experience. The platform also offers an immersive metaverse environment, where users can engage with NFTs in a dynamic and interactive way.",
  },
  {
    ...
    <div className="bg-[#050C24] font-interfont">
      <div className="relative mx-auto pt-6 flex flex-col items-center justify-center text-[#D2DADF] bg-[url('/assets/nft/infynft/gradient.svg')] bg-cover">
        ...
        >
          <div className="md:max-w-[1120px] flex items-center justify-between md:px-0 md:gap-5 mb-8 md:mb-16 container md:mx-auto">
            <a href="#_" className="z-10">
              <img src="/assets/nft/infynft/0g-avatarnft-logo.svg" alt="logo" />
            </a>
            ...
            <div className="gap-2 md:flex hidden">
              <div className="gap-5 justify-center md:flex hidden z-10 group relative">
                <img
                  src="/assets/nft/infynft/searchicon.svg"
                  alt="searchicon"
          ...
          >
            <div className="md:max-w-[598px] flex flex-col gap-5 tracking-[0.01em]">
              <div className="text-[36px] lg:text-[52px] font-bold leading-[49px] lg:leading-[71px]">
                Bringing AI Avatars to Life with{" "}
              ...
              <div className="lg:text-[22px] text-lg leading-[25px] md:leading-[30px] font-normal">
                <span className="font-bold">0G-AvatarNFT</span> takes you to a new frontier
                where AI meets true blockchain ownership.Create, chat, and trade unique evolving
                avatars — powered by AI and secured by 0G’s INFT technology.
              </div>
              <div>
                <button onClick={() => navigate('/explore')} className="hover:border-white hover:border border border-transparent flex items-center gap-2 rounded px-3 py-2.5 text-sm font-semibold bg-gradient-to-r from-green-500 via-green-500 to-teal-500 text-white">
                  Explore Now
            ...
            <div className="max-w-[350px] md:max-w-[300px] w-full flex items-center md:justify-end">
              <img src="/assets/nft/infynft/round.png" alt="round" />
            </div>
          </div>
          {/* TOP COLLECTION */}
                    ...
                    <div className="flex items-center justify-center gap-3 ">
                      <div className="relative">
                        ...
                        <div className="text-red absolute -right-1 -top-1 flex h-[14px] w-[14px] rounded-full">
                          <img src="/assets/nft/infynft/right.png" alt="" />
                        </div>
                      </div>
        ...
        <div className="relative bg-[#1E2230] flex flex-col gap-4 sm:flex-row justify-between p-8 lg:p-12 drop-shadow-lg rounded-lg max-w-6xl px-5 w-11/12">
          <img
            src="/assets/nft/infynft/ctaback.svg"
            alt="cta"
          ...
          <div className="max-w-[1121px] flex flex-col gap-8 md:flex-row w-full justify-between pt-20">
            <div className="flex max-w-[282px] flex-col gap-8">
              ...
              <div className="text-lg">
                ...
                of all <span className="font-semibold">0G-AvatarNFT</span> with their
                fans and unique token collectors!
              </div>
              <div className="-mt-1 hidden md:block text-sm">
              &copy; 2023 0G-AvatarNFT. All Rights Reserved.
              </div>
            </div>
            ...
            &copy; {new Date().getFullYear()} 0G-AvatarNFT. All Rights Reserved.
            </div>
          </div>
        </div>
      </div>
